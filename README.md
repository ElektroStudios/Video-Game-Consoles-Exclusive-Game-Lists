...
The purpose of this repository is to serve as a reference point with the following Markdown files provided via the tables below to easily find and identify if a game was released exclusively for a specific platform or if it is a multi-platform game. You will also see Zip files available for download whose contents are all the entries of the respective table, in URL file format.
